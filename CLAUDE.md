...
| `node src/scripts/validate-content.js --registry-overlay content/validation-fixtures/settings/commerce-c4-c9-overlay.json` | 0 / 101 / 85 |
...
production-post warnings = 0；94 / 101 warnings 全來自 `content/validation-fixtures/`。本 phase **不重跑 validation**，僅 carry-forward；如有變動以新 phase 量測為準。
