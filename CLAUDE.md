...
最新 frozen baseline（HEAD = `bdca625`，2026-06-24）：download / noindex / listing opt-in preanalysis closed / frozen；source implementation deferred；MVP 文章 listing intent = **hold current state（undecided）**。
