...
| `npm run check:admin-markdown-export` | 86 / 86 |
...
**Phase 1 Admin UI / Markdown draft export MVP（latest landed @ `821ec38`，2026-06-27）**：
...
- Guard `check:admin-markdown-export` **86/86 PASS**
