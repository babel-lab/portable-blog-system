...
| `node src/scripts/validate-content.js --registry-overlay content/validation-fixtures/settings/commerce-c4-c9-overlay.json` | 0 / 140 / 106 |
...
| `npm run check:validation-report` | 26 / 0 |
