...
這篇筆記記錄 portable blog system 的 GitHub Pages 本機工作流程，同時作為 Admin UI / Markdown 匯出流程的測試內容。
...
這篇筆記整理了 GitHub Pages 本機 build 與 preview 的基本流程。後續可再補齊實際操作紀錄與截圖，並把 deploy 步驟的檢查一併整理進來。
