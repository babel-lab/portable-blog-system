---
title: "[validation-fixture] download formRef empty string"
slug: "test-download-form-ref-empty"
status: "ready"
draft: false
date: "2026-06-02"
description: "Phase 20260602-am-3 Option A fixture：故意觸發 download-form-ref-empty warning（empty string case）。"
...
本 fixture 故意設計 download.formRef 為空字串 → 觸發 `download-form-ref-empty`。
