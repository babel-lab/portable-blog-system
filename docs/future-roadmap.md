...
| 8-g-19-d | docs sync Phase 8-g-19 candidate 5 landings（本批）| 🔄 進行中 | 本文件（§3 表格 + §5.1 candidate 5 新增）+ `docs/phase-8g-completion-report.md`（Header / §1 / §2 / §3 / §5 / §6 / §7 / §8 同步；candidate 5 改為 ✅ landed）|
