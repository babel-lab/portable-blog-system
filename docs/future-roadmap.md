...
| 8-g-3 | Phase 8-g overall completion report（本批）| 🔄 進行中 | `docs/phase-8g-completion-report.md` + 本文件（§3 / §7.2 同步）|
...
- `docs/phase-8g-completion-report.md`（Phase 8-g overall 收尾報告；本批產出；8-g-1 fixture 仍 deferred）
