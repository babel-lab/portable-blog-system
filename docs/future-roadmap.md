...
| 8-g-18-e | docs sync Phase 8-g-18 candidate 7 landings（本批）| 🔄 進行中 | 本文件（§3 表格 + §5.1 candidate 7 新增）+ `docs/phase-8g-completion-report.md`（Header / §1 / §2 / §3 / §5 / §7 同步；candidate 7 改為 ✅ landed）|
