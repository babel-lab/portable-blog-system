...
⭐ ~~**推薦第二**：**B4（fbPostedAt 排序 option）** 或 **B5（Sort indicator）**~~ ✅ **B4 已於 20260523-pm-16 落地**（commit `2df85e2`）；B5 仍可啟動（屬純視覺；既有 sort label 已含 asc / desc 文字）。
...
| B1-B6 | user 表態（語意 / 展示需求）| 完成 A 系列後可逐次 evaluate；**B4 ✅ 落地 pm-16 `2df85e2`**（fbPostedAt sort option；無 user 決策需求；屬例外）；B1 / B2 / B3 / B5 / B6 仍待 user 表態 |
