...
⭐ ~~**推薦最高**：**A1（sourceSite filter）**~~ ✅ **已於 20260523-pm-3 落地**（commit `f7dd897`）。後續 A2 ✅ 落地 pm-5 `b9b76c6` / A7 ✅ 落地 pm-10 `53bf60c`；A3 stale；A4-A6 仍可啟動（per §10.4）。
...
|---|---|---|
| A1-A7 | 無 | 任何時候可啟動；A1 ✅ 落地 pm-3 `f7dd897` / A2 ✅ 落地 pm-5 `b9b76c6` / A3 stale（per pm-2 補正；2026-05-21 `da00f53` 早已實作）/ A7 ✅ 落地 pm-10 `53bf60c`；A4-A6 仍未啟動 |
