...
//        驗 envelope 形狀 + totals 與 validate:content baseline 一致（0/112/102）+ per-entry shape。
//
...
const BASELINE = { errorCount: 0, warningCount: 112, issuePostCount: 102 };
...
if (existsSync(REPORT_PATH)) {
  ...
  check('B2 totals match validate:content baseline (0/112/102)', () => {
